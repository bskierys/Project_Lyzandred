# README for Task 7: Main Menu Widget
...
Knight
* Primary Ability: None (for now)
* Secondary Ability: None (for now)
* Other: Wall Jump

## Known issues

* Magic Pulse is in very early development stage and has a lot of issues. E.g.
	* It does not restart after character death
