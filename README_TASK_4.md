# README for Task 4: Sprint

This package can be used for assessing both Task 3 and 4 as it is iteration over
the previous package. To simplify this, I added the notes for Task 3 at the
bottom.
